...
/** This program computes the volume (in liters) of a six-pack of soda cans and the total volume of a six-pack and a
...
public class Volume1 {
    public static void main(String[] args){
        ...
        final double BOTTLE_VOLUME = 2; // Liters in a two-liter bottle
